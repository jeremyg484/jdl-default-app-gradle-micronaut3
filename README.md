...
This application was generated with the *in-progress Micronaut framework 3 development version* of [MHipster](https://github.com/jhipster/generator-jhipster-micronaut), a [Micronaut](https://micronaut.io) blueprint for [JHipster](https://www.jhipster.tech)!
...
Specifically, this application was generated using *a modified version of* the [`jdl-default-app.jdl`](https://github.com/jeremyg484/generator-jhipster-micronaut/blob/micronaut-3-fixes/test-integration/samples/jdl-default-app.jdl).

The .jdl script was edited to specify `gradle` as the `buildTool` then from a from a new directory parallel to the generator-jhipster-micronaut cloned repository, the following commands were executed:
```
npm link generator-jhipster-micronaut
mhipster jdl ../generator-jhipster-micronaut/test-integration/samples/jdl-default-app.jdl --skip-jhipster-dependencies --force
```
